...
public class UserStatsController {
    ...
    @FXML
    private Label userLossesLabel;
    @FXML
    private Label userWinRatioLabel;
    @FXML
    private Label userFastestWinLabel;
    @FXML
    private Label noGamesPlayedLabel;

    /**
     * This method retrieves and displays the user's profile statistics when
     * they click the "Get My Stats!" button.
     */
    @FXML
