...
public class UsersManager {
	...
	/**
	 * This method creates a loads a user into the hashmap and saves the user to the
	 * fil
	 *
	...
	/**
	 * This method loads all users from the user details CSV file and puts each user
	 * into the hashMap
	 */
	...
	/**
	 * This method reads the CSV file for user details and returns a list of the
	 * user details
	 *
	 * @return A list of String[] where each String[] represents a user and their
	 *         details
	 * @throws IOException
	 * @throws CsvException
	 * @throws URISyntaxException
